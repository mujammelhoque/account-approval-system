                        ...
                        <div class="x_content">
                            ...
                            <form action="{{ route('income-expense-store') }}" method="post">
                                ...
                                <div class="field item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3  label-align">Debit Voucher Number<span class="required">*</span></label>

                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" readonly type="text" name="debit_voucher_number" value="{{ $debit_number }}" >
                                    </div>
                                </div>
                                <div class="field item form-group">
                             ...
                             <label class="col-form-label col-md-3 col-sm-3  label-align" for="yesCheck"><strong>Check</strong></label>
                            <div class="col-md-3 col-sm-3" >
                             <input type="radio" class="form-control" onclick="javascript:yesnoCheck();" name="yesno" id="yesCheck"/> 
                            </div>
                             <label class="col-form-label" for="noCheck"><strong>Cash</strong></label>
                             <div class="col-md-3 col-sm-3" >
                                ...
                                <div class="field item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3  label-align">Bank  <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6">
